...
class ProjectServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        view()->composer(['book.create', 'particals.nav-bar-v2', 'admin.books.index', 'particals.header-v2', 'particals.categories', 'categories.content', 'post.content-post'], 'App\Http\ViewComposers\CategoryComposer');
