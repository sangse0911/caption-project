...
<head>
    ...
    <link href="{{ asset('css/laraspace1954.css') }}" rel="stylesheet" type="text/css"> {{--
...
<body class="layout-default skin-default">
    <div id="app" class="site-wrapper">
        <header class="site-header">
            ...
            <ul class="action-list">
                ...
                <li>
                    <a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="avatar"><img src="{{ asset('img/avatars/avatar.png') }}" alt="Avatar"></a>
                    <div class="dropdown-menu dropdown-menu-right notification-dropdown">
                        <a class="dropdown-item" href="http://laraspace.in/admin/settings"><i class="icon-fa icon-fa-cogs"></i> Settings</a>
                        <a class="dropdown-item" href="http://laraspace.in/logout"><i class="icon-fa icon-fa-sign-out"></i> Logout</a>
                    </div>
                </li>
            </ul>
        </header>
    ...
    <script src="{{ asset('js/core/plugins7790.js') }}"></script>
    <script src="{{ asset('js/demo/skintools.js') }}"></script>
    <script src="{{ asset('js/core/appe91a.js') }}"></script>
    @yield('script')
</body>
<!-- Mirrored from laraspace.in/admin/dashboard/ecommerce by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Sep 2017 01:37:33 GMT -->
