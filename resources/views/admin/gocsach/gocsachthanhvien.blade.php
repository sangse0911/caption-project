...
@section('title') Trang Quản Trị | Danh Sách Thành Viên @endsection
@section('css') 
...
<div class="content-area py-1">
	<div class="container-fluid">
		<ol class="breadcrumb no-bg mb-1">
			<h4>Thành Viên Góc Sách</h4>
			<li class="breadcrumb-item active">Góc Sách</li>
			<li class="breadcrumb-item active">Thành Viên</li>
			<div style="float: right;"><a href="themquantri.blade.php"><button type="button" class="btn btn-info btn-lg label-right b-a-0 waves-effect waves-light">
