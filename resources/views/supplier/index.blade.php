                ...
                <div class="modal-dialog modal-lg" style="max-width: 1100px;">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group col-md-6" id="rent-area">
                                <h6>Giá Thuê</h6>
            ...
            <table class="table table-striped table-bordered dataTable" id="table-1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <button type="button" id="update-{{ $supplier->id }}" class="btn btn-success btn-sm btn-update label-left b-a-0 waves-effect waves-light" data-toggle="modal" data-target="#myModal">
