                            ...
                            <aside class="widget clearfix">
                                <div class="body">
                                    ...
                                    <ul class="product_list_widget">
                                        ...
                                        <img class="wp-post-image" data-echo="assets/images/footer/1.jpg" src="{!! asset('assets/images/blank.gif') !!}" alt="">
                                        ...
                                        <img class="wp-post-image" data-echo="assets/images/footer/2.jpg" src="{!! asset('assets/images/blank.gif') !!}" alt=""><span class="product-title">Smartphone 6S 128GB LTE</span>
                                    </a>
                                            <span class="electro-price"><span class="amount">&#36;780.00</span></span>
                                        </li>
                                        <li>
                                            <a href="single-product.html" title="Smartphone 6S 64GB LTE">
                                        <img class="wp-post-image" data-echo="assets/images/footer/3.jpg" src="{!! asset('assets/images/blank.gif') !!}" alt="">
                            ...
                            <aside class="widget clearfix">
                                <div class="body">
                                    ...
                                    <ul class="product_list_widget">
                                        ...
                                        <img class="wp-post-image" data-echo="assets/images/footer/4.jpg" src="{!! asset('assets/images/blank.gif') !!}" alt="">
                                        ...
                                        <img class="wp-post-image" data-echo="assets/images/footer/5.jpg" src="{!! asset('assets/images/blank.gif') !!}" alt="">
                                        <span class="product-title">Widescreen 4K SUHD TV</span>
                                    </a>
                                            <span class="electro-price"><ins><span class="amount">&#36;2,999.00</span></ins>
                                            <del><span class="amount">&#36;3,299.00</span></del>
                                            </span>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <aside class="widget clearfix">
                                <div class="body">
                                    ...
                                    <ul class="product_list_widget">
                                        <li>
                                            <a href="single-product.html" title="Notebook Black Spire V Nitro  VN7-591G">
                                        <img class="wp-post-image" data-echo="assets/images/footer/6.jpg" src="{!! asset('assets/images/blank.gif') !!}" alt="">
                                        <span class="product-title">Notebook Black Spire V Nitro  VN7-591G</span>
                                    </a>
                                            <div class="star-rating" title="Rated 5 out of 5"><span style="width:100%"><strong class="rating">5</strong> out of 5</span></div> <span class="electro-price"><ins><span class="amount">&#36;1,999.00</span></ins>
                                            <del><span class="amount">&#36;2,299.00</span></del>
                                            </span>
                                        </li>
                                        <li>
                                            <a href="single-product.html" title="Apple MacBook Pro MF841HN/A 13-inch Laptop">
                                        <img class="wp-post-image" data-echo="assets/images/footer/7.jpg" src="{!! asset('assets/images/blank.gif') !!}" alt="">
                                        ...
                                        <img class="wp-post-image" data-echo="assets/images/footer/2.jpg" src="{!! asset('assets/images/blank.gif') !!}" alt="">
