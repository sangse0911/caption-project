...
@endsection
@section('script')
<script type="text/javascript" src="{{ URL::to('vendor/dropify/dist/js/dropify.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::to('vendor/flot/jquery.flot.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::to('vendor/flot/jquery.flot.resize.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::to('vendor/flot.tooltip/js/jquery.flot.tooltip.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::to('vendor/CurvedLines/curvedLines.js') }}"></script>
<script type="text/javascript" src="{{ URL::to('vendor/TinyColor/tinycolor.js') }}"></script>
<script type="text/javascript" src="{{ URL::to('vendor/sparkline/jquery.sparkline.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::to('vendor/raphael/raphael.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::to('vendor/morris/morris.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::to('vendor/jvectormap/jquery-jvectormap-2.0.3.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::to('vendor/jvectormap/jquery-jvectormap-world-mill.js') }}"></script>
<script type="text/javascript" src="{{ URL::to('vendor/peity/jquery.peity.js') }}"></script>
<script type="text/javascript" src="{{ URL::to('js/ckeditor/ckeditor.js') }}"></script>
<script type="text/javascript" src="{{ URL::to('js/forms-upload.js') }}"></script>
