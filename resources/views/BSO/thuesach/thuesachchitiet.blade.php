...
@endsection
@section('content') 
@section('body')<body class="single-product full-width">@endsection
				...
				<div class="product">
					...
					<div class="single-product-wrapper">
						<div class="product-images-wrapper">
                            ...
                            <div class="images electro-gallery">
                             <div class="thumbnails-single owl-carousel">
                              <a href="BSO/assets/images/single-product/s1-1.jpg" class="zoom" title="" data-rel="prettyPhoto[product-gallery]">
                               <img src="BSO/assets/images/blank.gif" data-echo="BSO/assets/images/dacnhantam.jpg" class="wp-post-image" alt="">
                           </a>

                           <a href="BSO/assets/images/single-product/s1.jpg" class="zoom" title="" data-rel="prettyPhoto[product-gallery]">
                               <img src="BSO/assets/images/blank.gif" data-echo="BSO/assets/images/dacnhantam.jpg" class="wp-post-image" alt="">
                           </a>
                       ...
                       <div class="thumbnails-all columns-5 owl-carousel">
                          <a href="BSO/assets/images/single-product/single-thumb1.jpg" class="first" title="">
                           <img src="BSO/assets/images/blank.gif" data-echo="BSO/assets/images/dacnhantam.jpg" class="wp-post-image" alt="">
                       </a>
   ...
   <div itemprop="offers" itemscope itemtype="http://schema.org/Offer">
    ...
    <form class="variations_form cart" method="post">
     ...
     <table class="variations">
      <tbody>
       <tr>
        <td class="label"><label>Chất Lượng Sách</label></td>
        <td class="value">
    ...
    <div id="reviews" class="electro-advanced-reviews">
     <div class="advanced-review row">
      <div class="col-xs-12 col-md-6">
       <h2 class="based-title">Khách Hàng Nhận Xét</h2>
       <div class="avg-rating">
        <span class="avg-rating-number">4.3</span> Đánh Giá Trung Bình
    </div>
   ...
   <div id="review_form_wrapper">
    <div id="review_form">
     <div id="respond" class="comment-respond">
      <h3 id="reply-title" class="comment-reply-title">Đăng Nhập để gửi nhận xét của bạn
...
<p class="form-submit">
    <input name="submit" type="submit" id="submit" class="submit" value="Gửi Nhận Xét" />
  ...
  <ol class="commentlist">
   <li itemprop="review" class="comment even thread-even depth-1">
    ...
    <div id="comment-390" class="comment_container">
     ...
     <img alt='' src="BSO/assets/images/blog/avatar.jpg" class='avatar' height='60' width='60' />
   ...
   <p class="meta">
       <strong itemprop="author">Dương Trường</strong> &ndash; <time itemprop="datePublished" datetime="2016-03-03T14:13:48+00:00">2017-10-16 08:43</time>
   </p>
...
<li class="comment odd alt thread-odd thread-alt depth-1">
   ...
   <p class="meta">
       <strong itemprop="author">Nam Nghia</strong> &ndash; <time itemprop="datePublished" datetime="2016-03-03T14:14:47+00:00">2017-10-13 11:24</time>
   </p>
